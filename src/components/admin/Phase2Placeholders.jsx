...
export const Phase2Placeholders = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6 select-none">
      ...
      <div className="bg-[#1A1A1D] rounded-2xl p-5 border border-[#2A2A2E] shadow-sm relative overflow-hidden">
        ...
        <div className="pt-3 border-t border-[#2A2A2E] flex items-center justify-between text-xs text-[#9CA3AF]">
          ...
          <span className="font-semibold text-[#F5F5F5]">
            {stats?.fuel_anomalies > 0 ? 'Anomaly Detected' : 'Normal Threshold'}
          </span>
        </div>
      </div>
      ...
      <div className="bg-[#1A1A1D] rounded-2xl p-5 border border-[#2A2A2E] shadow-sm relative overflow-hidden">
        ...
        <div className="pt-3 border-t border-[#2A2A2E] flex items-center justify-between text-xs text-[#9CA3AF]">
          ...
          <span className="font-semibold text-[#F5F5F5]">Queue Active</span>
        </div>
      </div>
    </div>
  );
